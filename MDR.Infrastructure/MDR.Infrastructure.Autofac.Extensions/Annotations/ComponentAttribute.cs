...
public class ComponentAttribute : Attribute
{
    ...
    ///     作用域
    /// </summary>
    public Scope AutofacScope { get; set; } = Scope.Singleton;
    ...
    public ComponentAttribute(Type _service)
    {
        Service = _service;
    }
    ...
    public ComponentAttribute(Type _service, string key) : this(_service)
    {
        Key = key;
    }
