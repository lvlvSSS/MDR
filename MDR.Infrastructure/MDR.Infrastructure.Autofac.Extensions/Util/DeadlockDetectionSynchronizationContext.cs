...
namespace MDR.Infrastructure.Autofac.Extensions.Util;
...
internal class DeadLockCheck : IDisposable
{
    ...
    private DeadLockCheck(string caller)
    {
        ...
        _deadlockDetectionSynchronizationContext =
            new DeadlockDetectionSynchronizationContext(currentSynchronizationContext, caller);
