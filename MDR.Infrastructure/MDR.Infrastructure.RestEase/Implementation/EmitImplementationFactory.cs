...
internal class EmitImplementationFactory
{
    ...
    private static readonly Lazy<EmitImplementationFactory> lazyFactory = new Lazy<EmitImplementationFactory>(() => new EmitImplementationFactory(), LazyThreadSafetyMode.ExecutionAndPublication);
