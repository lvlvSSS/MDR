...
using static MDR.Infrastructure.RestEase.Implementation.EmitEmitUtils;
...
internal class MethodEmitter
{
    ...
    {
        foreach (var baseType in EnumerableExtension.Concat(input, input.GetTypeInfo().GetInterfaces()))
        {
